...
int main(int argc, char* argv[])
{
    ...
    if (load_map(argv[1], gameStats.maze_map) != 0)
    {
    ...
    gameStats.wallTextures[0] = load_texture("./images/wall1.jpg");
    gameStats.wallTextures[1] = load_texture("./images/wall2.jpg");
    gameStats.wallTextures[2] = load_texture("./images/wall3.jpg");
    gameStats.wallTextures[3] = load_texture("./images/wall4.jpg");
    gameStats.floorTexture = load_texture("./images/floor.jpg");

    /** Game loop */
    bool running = true;
    while (running)
    {
        handle_input(&player, &running, gameStats.maze_map);
