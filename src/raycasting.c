...
float cast_ray(float playerX, float playerY, float rayAngle)
{
	...
	calculate_step_and_side_dist(rayDirX, rayDirY, &mapX, &mapY,
		&stepX, &stepY, &sideDistX, &sideDistY, playerX, playerY);
 ...
 */
float get_wall_hit_coordinates(float playerX, float playerY,
